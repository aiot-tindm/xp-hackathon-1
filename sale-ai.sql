...
DROP DATABASE IF EXISTS `sales_ai_db`;
CREATE DATABASE `sales_ai_db` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `sales_ai_db`;
